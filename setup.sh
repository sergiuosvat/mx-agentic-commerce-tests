...
echo "  cd $SCRIPT_DIR && ./run_all_tests.sh"
echo ""
echo "Run a single integration suite (single-threaded):"
echo "  cargo test --test suite_a_identity -- --test-threads=1 --nocapture"
echo "  # or: cargo itest --test suite_a_identity"
echo ""
echo "Run package-level chain tests:"
echo "  ./run_all_tests.sh --pkg"
echo ""
echo "Run MPP TypeScript unit tests:"
echo "  cd $SCRIPT_DIR && npm install && npm run test:unit"
echo ""
